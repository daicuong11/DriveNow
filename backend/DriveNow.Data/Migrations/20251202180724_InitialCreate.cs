        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityCard = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleInOuts", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_VehicleInOuts_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_RentalOrders_RentalOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalOrders_EmployeeId",
                table: "RentalOrders",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleColors_Code",
                table: "VehicleColors",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VehicleInOuts_EmployeeId",
                table: "VehicleInOuts",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleInOuts_VehicleId",
                table: "VehicleInOuts",
                column: "VehicleId");
